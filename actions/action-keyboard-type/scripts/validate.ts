#!/usr/bin/env npx tsx
/**
 * Validates a single keyboard_type step object.
 * Usage: npx tsx server/skills/workflow-builder/actions/action-keyboard-type/scripts/validate.ts <step.json>
 */
...
function validateStep(step: unknown): void {
  ...
  if (step.action_type !== "keyboard_type") err(`${p}.action_type`, 'must be "keyboard_type"');
