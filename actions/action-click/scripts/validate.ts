#!/usr/bin/env npx tsx
/**
 * Validates a single click step object.
 * Usage: npx tsx server/skills/workflow-builder/actions/action-click/scripts/validate.ts <step.json>
 */
...
function validateStep(step: unknown): void {
  ...
  if (step.action_type !== "click") err(`${p}.action_type`, 'must be "click"');
