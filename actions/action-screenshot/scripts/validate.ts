#!/usr/bin/env npx tsx
/**
 * Validates a single screenshot step object.
 * Usage: npx tsx server/skills/workflow-builder/actions/action-screenshot/scripts/validate.ts <step.json>
 */
...
function validateStep(step: unknown): void {
  ...
  if (step.action_type !== "screenshot") err(`${p}.action_type`, 'must be "screenshot"');
